...
app.post('/api/handle', (req, res) => {
  ...
  switch(req.body.node) {
    ...
    case 'bwa_extract':
      ...
      str += ' && ' +'sed \'1d\' ' + directorystr + req.body.project + '/pipeline/bwaResult/test.sort_CpG.bedGraph > '+ directorystr + req.body.project + '/pipeline/bwaResult/bwareport.bed';
      str += ' && ' +'awk \'{print $1 "\\t" $2 "\\t" $3 "\\t" $4/100 "\\t" $5+$6}\' ' + directorystr + req.body.project + '/pipeline/bwaResult/test.sort_CpG.bedGraph > '+ directorystr + req.body.project + '/pipeline/bwaResult/bwareport.bed';
      break;
    ...
    case 'bitmapperBS_extract':
      ...
      str += ' && ' +'sed \'1d\' ' + directorystr + req.body.project + '/pipeline/bitmapperResult/test.sort_CpG.bedGraph > '+ directorystr + req.body.project + '/pipeline/bitmapperResult/bitmapperBSreport.bed';
      str += ' && ' +'awk \'{print $1 "\\t" $2 "\\t" $3 "\\t" $4/100 "\\t" $5+$6}\' ' + directorystr + req.body.project + '/pipeline/bitmapperResult/test.sort_CpG.bedGraph > '+ directorystr + req.body.project + '/pipeline/bitmapperResult/bitmapperBSreport.bed';
      break;
    case 'gemBS_extract':
      str = 'gemBS call';
      str += ' && '+'gemBS extract';
  ...
  switch(req.body.report) {
    ...
    case 'intersect':
      ...
      if (req.body.reportmethod.length == 2) {
        ...
        str = 'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[0] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/' + req.body.reportmethod[1] + '.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/1.bed';
        str += ' && ' +'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[2] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/1.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/intersect.bed';
        ...
        str += ' && ' +'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[2] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/1.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/2.bed';
        str += ' && ' +'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[3] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/2.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/intersect.bed';
        ...
        str = 'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[0] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/' + req.body.reportmethod[1] + '.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/1.bed';
        str += ' && ' +'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[2] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/1.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/2.bed';
        str += ' && ' +'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[3] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/2.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/3.bed';
        str += ' && ' +'bedtools intersect -a '+directorystr+req.body.project+'/pipeline/intersect/'+req.body.reportmethod[4] + '.bed -b '+directorystr+req.body.project+'/pipeline/intersect/3.bed -wa -wb > '+directorystr+req.body.project+'/pipeline/intersect/intersect.bed';
